...
//
  ...
  #define BED_CHECK_INTERVAL 3000   // (ms) Interval between checks in bang-bang control
...
#define HOMING_BUMP_MM      { 10, 15, 10 }       // (mm) Backoff from endstops after first bump
